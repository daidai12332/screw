package com.example.screw.exception;
...
public class GlobalExceptionHandler {
	...
	@ExceptionHandler({MethodArgumentNotValidException.class})   // 大括號可以放多個
	public ResponseEntity<Map<String, Object>> paramExceptionHandler(MethodArgumentNotValidException e) {
		// 因為在 controller 中的 res 返回的是 code: 數值 和 message: 字串；所以 map 的 value 用 Object 接 (就可放 int 或 String)
